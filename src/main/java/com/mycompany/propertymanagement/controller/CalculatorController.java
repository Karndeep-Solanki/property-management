...
public class CalculatorController {
    ...
    //http://localhost:8080/api/v1/calculator/substract/num1/num2
    @GetMapping("/substract/{num1}/{num2}")//map the value of the url to java variable by path variable method
